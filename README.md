# com-chilipeppr-workspace-gregorywjohnson
A ChiliPeppr workspace that maps 2D contours to 3D surfaces.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / gregorywjohnson
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-gregorywjohnson |
| Name                  | Workspace / gregorywjohnson |
| Description           | A ChiliPeppr workspace that maps 2D contours to 3D surfaces. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/gregorywjohnson/workspace-gregorywjohnson/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/gregorywjohnson/autodriller |
| Github URL            | http://github.com/gregorywjohnson/workspace-gregorywjohnson |
| Test URL              | https://preview.c9users.io/gregorywjohnson/autodriller/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/gregorywjohnson/workspace-gregorywjohnson/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-gregorywjohnson"], // the id you gave your workspace
      function(myWorkspaceGregorywjohnson) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / gregorywjohnson just got loaded.", myWorkspaceGregorywjohnson);
        myWorkspaceGregorywjohnson.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-gregorywjohnson"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / gregorywjohnson"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr workspace that maps 2D contours to 3D surfaces."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/gregorywjohnson/workspace-gregorywjohnson/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/gregorywjohnson/autodriller"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/gregorywjohnson/workspace-gregorywjohnson"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://autodriller-gregorywjohnson.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
